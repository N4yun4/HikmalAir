   ...
   <div class="meals-container">
    ...
    <div class="order-summary-container">
      ...
      <div class="text-end mt-4 pt-3 border-top" id="totalSection" style="display: none;">
       ...
       {{-- UBAH INI JADI FORM --}}
                    <form id="confirmMealsForm" action="{{ route('booking.processBooking') }}" method="POST">
                        @csrf
                        {{-- Ini akan menjadi wadah untuk input hidden yang dibuat oleh JavaScript --}}
                        <div id="selectedMealsHiddenInputs"></div> 
